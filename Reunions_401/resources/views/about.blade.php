...
<body>
	...
	<div class = "container px-lg-5">
		...
		<div class="col-6 col-md-3 px-lg-3" style = "text-align:right"><img src = "/icons/benji.jpeg" height = 150px></div>
		...
		<div class="col-6 col-md-3 px-lg-3"><img src = "/icons/alex.jpeg" height = 150px></div>
	  	
	  </div>

	  <div class="row px-lg-5 mt-5 mb-5 align-items-center"  style = "text-align:left">
		<div class="col-6 col-md-3 px-lg-3" style = "text-align:right"><img src = "/icons/dee-dee.png" height = 150px></div>
		...
		<div class="row px-lg-5 mt-5 mb-5 align-items-center"  style = "text-align:left">
	  	...
	  	<div class="col-6 col-md-3 px-lg-3"><img src = "/icons/yang.jpeg" height = 150px></div>
	  </div>
	</div>
